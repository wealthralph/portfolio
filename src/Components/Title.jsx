...
const Title = () => {
    return (
        <div>
            <h1 className='hero-heading'>Building Digital Experiences For The Mordern Web</h1>
            <p className="hero-des">
                I am a full-stack web developer. I write in 
                ...
                as well as on my blog, thevunderkind.com.</p>
            <p></p>
        </div>
    )
}
